...
<style>
    ...
    .fixed-header {
        ...
        background-color: black; /* Change the background color if needed */
    }
    .fixed-headerr {
        position: fixed;
        top: 38px;
...
<body class="font-sans">
    <!-- Fixed Header -->
    <header class="fixed-header flex bg-black text-white flex justify-between items-center p-4 text-sm p-flex">
        ...
        <div class="flex items-center space-x-12">
            ...
            <div class="flex items-center space-x-2">
                ...
                <span>info@taskmaster.com</span>
            </div>
        </div>
        <nav class="flex space-x-4">
            <a href="#" class="hover:underline"><i class="fab fa-twitter"></i>&nbsp;&nbsp;Twitter</a>
            <a href="#" class="hover:underline"><i class="fab fa-facebook"></i>&nbsp;&nbsp;Facebook</a>
        </nav>
    </header>

    <!-- Main Header -->
    <header class="fixed-headerr flex bg-red-700 text-white flex justify-between items-center p-4">
        <div class="logo">
            <h2 class="text-background">TaskMaster</h2>
        </div>
        <nav class="nav flex space-x-6 ">
            <a href="/task-management/main.php" class="hover:underline">Home</a>
            <a href="/task-management/pages/aboutus.php" class="hover:underline">About Us</a>
            <a href="#" class="hover:underline">Contacts</a>
            <?php if (isset($_SESSION['role_type']) && $_SESSION['role_type'] == "admin"): ?>
        <a href="/task-management/categories.php" class="hover:underline">Categories</a>
        <a href="/task-management/tasks.php" class="hover:underline">Tasks of User</a>
    ...
    <?php elseif (isset($_SESSION['role_type']) && $_SESSION['role_type'] == "user"): ?>
        <a href="/task-management/tasks/mytasks.php" class="hover:underline">MyTasks</a>
    <?php endif; ?>
        ...
        <div class="flex relative">
            ...
            <?php if(isset($_SESSION['username'])): ?>
                <div class="voltage-button flex bg-red-700 text-white">
                    <h2 class="p-4 space-x-6"> Welcome <?php echo $_SESSION['username']; ?></h2>
                    <button><a href="/task-management/authentificate/logout.php">Logout</a></button>
                ...
                <?php else: ?>
                <button><a href="/task-management/authentificate/login.php">Login</a></button>
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 234.6 61.3" preserveAspectRatio="none" xml:space="preserve">
            ...
            <div class="voltage-button flex bg-red-700 text-white">
                ...
                <button><a href="/task-management/authentificate/register.php">SingUp</a></button>
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 234.6 61.3" preserveAspectRatio="none" xml:space="preserve">
